...
![SnakeRaven mounted on the RAVEN II, with the adaptor piece and the snake end-effector](https://github.com/Andrew-Raz-ACRV/SnakeRaven-Project/blob/main/images/FrontCoverSnake2.png)
