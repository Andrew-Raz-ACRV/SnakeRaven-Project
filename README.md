...
![SnakeRaven mounted on the RAVEN II, with the adaptor piece and the snake end-effector](https://github.com/Andrew-Raz-ACRV/snake_raven_controller/blob/master/FrontCoverSnake2.png)
